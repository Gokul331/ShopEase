...
const Navbar = () => {
  ...
  // Close suggestions when clicking outside - FIXED VERSION
  useEffect(() => {
    const handleClickOutside = (event) => {
      // Check if click is outside both search input and suggestions dropdown
  ...
  // FIXED: Handle suggestion click without event propagation issues
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              {user ? (
                <div className="flex items-center gap-2 sm:gap-3">
                  <Link
                    to="/profile"
                    className="hidden sm:flex items-center gap-2 px-2 sm:px-3 py-2 text-gray-700 hover:text-indigo-600 transition-colors group"
                  >
                    <FiUser size={16} className="sm:size-4" />
                    <span className="text-sm font-medium max-w-[80px] lg:max-w-[100px] truncate">
                      {user.username}
                    </span>
                  </Link>
                  <button
                    onClick={handleLogout}
                    className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 py-2 text-gray-700 hover:text-red-600 transition-colors"
                    title="Logout"
                  >
                    <FiLogOut size={16} className="sm:size-4" />
                ...
                <div className="flex items-center gap-1 sm:gap-2">
                  <Link
                    to="/login"
                    className="px-2 sm:px-3 py-1 sm:py-2 text-xs sm:text-sm text-gray-700 hover:text-indigo-600 transition-colors font-medium whitespace-nowrap"
                  >
                    Login
                  </Link>
                  <Link
                    to="/register"
                    className="px-2 sm:px-3 py-1 sm:py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors font-medium text-xs sm:text-sm whitespace-nowrap"
                  >
                    Sign Up
                  </Link>
                </div>
