          ...
          <div className="flex items-center justify-between relative">
            ...
            {[1, 2, 3].map((step) => (
              <div key={step} className="flex flex-col items-center z-10">
                <div className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-xl sm:rounded-2xl flex items-center justify-center transition-all duration-300 ${
                  activeStep >= step 
                  ...
                  {activeStep > step ? <FiCheck className="text-sm sm:text-base md:text-xl" /> : step}
                </div>
                <span className={`text-xs sm:text-sm font-medium mt-2 sm:mt-3 ${
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 max-w-7xl mx-auto">
          ...
          <div className="xl:col-span-2 space-y-4 sm:space-y-6">
              ...
              >
                <div>
                  ...
                  <p className="text-slate-600 text-sm">
                    {cart.items.length} item{cart.items.length !== 1 ? 's' : ''} • ${finalTotal.toFixed(2)}
                  </p>
                </div>
                {showOrderSummary ? (
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl border border-white/20 p-4 sm:p-6 lg:p-8">
              ...
              {error && (
                <div className="bg-red-50 border border-red-200 text-red-700 px-4 sm:px-6 py-3 sm:py-4 rounded-xl mb-4 sm:mb-6 flex items-center gap-3 text-sm sm:text-base">
                  <FiShield className="text-red-500 text-base sm:text-lg flex-shrink-0" />
                  {error}
                </div>
              )}
                  ...
                  <div className="mb-4 sm:mb-6">
                    ...
                    <div className="grid grid-cols-1 gap-2 sm:gap-3">
                      {savedAddresses.map((addr) => (
                        <label
                          key={addr.id}
                          className={`p-3 sm:p-4 border-2 rounded-xl sm:rounded-2xl flex items-start gap-3 sm:gap-4 cursor-pointer transition-all duration-200 ${
                        ...
                        >
                          <input
                            ...
                            className="mt-0.5 sm:mt-1 w-4 h-4 sm:w-5 sm:h-5 text-indigo-600 focus:ring-indigo-500 flex-shrink-0"
                          />
                          <div className="flex-1 min-w-0">
                            <div className="font-semibold text-slate-800 text-sm sm:text-base">
                              {addr.label || `${addr.line1}`}
                            </div>
                            <div className="text-slate-600 text-xs sm:text-sm mt-1 leading-tight">
                              {addr.line1}
                      ...
                      <button
                        ...
                        className="text-indigo-600 hover:text-indigo-700 font-medium text-xs sm:text-sm mt-1 sm:mt-2 flex items-center gap-2 transition-colors"
                      >
                        + Add New Address
                      </button>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="relative">
                      <FiUser className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 text-base sm:text-lg" />
                      <input
                        type="text"
                        name="fullName"
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="relative">
                      <FiMail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 text-base sm:text-lg" />
                      <input
                        type="email"
                        name="email"
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl border border-white/20 p-4 sm:p-6">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 text-center">
                <div className="flex flex-col items-center gap-1 sm:gap-2 p-2 sm:p-3">
                  ...
                  <span className="text-xs sm:text-sm font-medium text-slate-700">SSL Secure</span>
                </div>
                <div className="flex flex-col items-center gap-1 sm:gap-2 p-2 sm:p-3">
                  <FiLock className="text-blue-500 text-xl sm:text-2xl" />
                  <span className="text-xs sm:text-sm font-medium text-slate-700">Encrypted</span>
                </div>
                <div className="flex flex-col items-center gap-1 sm:gap-2 p-2 sm:p-3">
                  <FiClock className="text-orange-500 text-xl sm:text-2xl" />
                  <span className="text-xs sm:text-sm font-medium text-slate-700">Fast Checkout</span>
                </div>
                <div className="flex flex-col items-center gap-1 sm:gap-2 p-2 sm:p-3">
